...
CREATE TABLE `qr_logs` (
  ...
  CONSTRAINT `qr_logs_ibfk_1` FOREIGN KEY (`visit_id`) REFERENCES `visits` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `visits` (
  ...
  `status` enum('in','out','overdue') DEFAULT 'in',
  PRIMARY KEY (`id`),
...
-- Dump completed on 2025-11-26 21:23:01
